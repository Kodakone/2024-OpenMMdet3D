auto_scale_lr = dict(base_batch_size=20, enable=False)
backend_args = None
class_names = [
    'Pedestrian',
    'Cyclist',
...
model = dict(
    ...
    voxel_encoder=dict(
        ...
        type='SelfAdaptivePillarization',
        voxel_size=[
            0.16,
            0.16,
            4,
...
train_cfg = dict(by_epoch=True, max_epochs=20, val_interval=2) # 자주 검증해보자 과적합인가 아닌가
    ...
    dataset=dict(
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(flip_ratio_bev_horizontal=0.7, type='RandomFlip3D'), # 다양한 시점 학습 위해 증가 0.5 -> 0.7 
                dict(
                    rot_range=[
                        -0.78539816,
                        0.78539816,
...
train_pipeline = [
    ...
    dict(
        ...
        type='ObjectSample',
        use_ground_plane=False),
    dict(flip_ratio_bev_horizontal=0.2, type='RandomFlip3D'), # 플립 비율의 감소 0.5 -> 0.2
    dict(
        rot_range=[
            -0.78539816,
            0.78539816,

...
model = dict(
    ...
    pts_voxel_encoder=dict(
        type='DynamicVFE', # DynamicVFE/SelfAdaptiveVoxelization_D/SelfAdaptiveFeatureExtractor_DV
        in_channels=4,
        feat_channels=[64, 64], #원 [64, 64]
        with_distance=False,
        voxel_size=voxel_size,
...
visualizer = dict(
    ...
    ,save_dir='./work_dirs/mvxnet_train_ori/visualization')
